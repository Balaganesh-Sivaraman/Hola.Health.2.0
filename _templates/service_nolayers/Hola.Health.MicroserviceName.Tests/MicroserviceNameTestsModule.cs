...
using Hola.Health.MicroserviceName.Data;
using Volo.Abp;
...
using Hola.Health.MicroserviceName.Tests.MongoDB;
{{~ end~}}

namespace Hola.Health.MicroserviceName.Tests;

/* This project has a dotnet project reference to the Hola.Health.MicroserviceName project,
 * but it does not have a module dependency to the HealthMicroserviceNameModule module class.
 * Because, HealthMicroserviceNameModule has configurations proper for development and production
 ...
 *
 * For example, HealthMicroserviceNameModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthMicroserviceNameModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthMicroserviceNameModule))]
