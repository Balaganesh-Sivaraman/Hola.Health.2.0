...
[DependsOn(
    ...
    {{~ end~}}
    typeof(HealthMicroserviceNameContractsModule),
...
public class HealthMicroserviceNameModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthMicroserviceNameModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<HealthMicroserviceNameModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(HealthMicroserviceNameModule).Assembly, opts =>
                {
