...
using Hola.Health.Web.Public.Menus;
...
public class HealthWebPublicModule : AbpModule
{
    ...
    private static void PreConfigureDataAnnotations(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(HealthWebPublicResource),
                typeof(HealthWebPublicModule).Assembly
            );
        });
    }
    ...
    private void ConfigureLocalization(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthWebPublicResource>(typeof(HealthWebPublicModule).Namespace);
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<HealthWebPublicModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.Resources
                .Add<HealthWebPublicResource>("en")
                .AddVirtualJson("/Localization/HealthWebPublic");

            options.DefaultResourceType = typeof(HealthWebPublicResource);
        });
    }
    ...
    private void ConfigureNavigation(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new HealthPublicMenuContributor(configuration));
        });
    }
    ...
    private void ConfigureToolbar()
    {
        ...
        {
            options.Contributors.Add(new HealthToolbarContributor());
        });
    }
