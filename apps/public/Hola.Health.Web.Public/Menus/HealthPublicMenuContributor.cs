...
namespace Hola.Health.Web.Public.Menus;

public class HealthPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public HealthPublicMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<HealthWebPublicResource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                HealthPublicMenus.HomePage,
                l["Menu:HomePage"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                HealthPublicMenus.ArticleSample,
