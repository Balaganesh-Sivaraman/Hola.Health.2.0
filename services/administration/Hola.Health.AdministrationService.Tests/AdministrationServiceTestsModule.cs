...
namespace Hola.Health.AdministrationService.Tests;

/* This project has a dotnet project reference to the Hola.Health.AdministrationService project,
 * but it does not have a module dependency to the HealthAdministrationServiceModule module class.
 * Because, HealthAdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthAdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthAdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthAdministrationServiceModule))]
