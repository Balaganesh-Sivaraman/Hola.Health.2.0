...
namespace Hola.Health.AdministrationService;
...
[DependsOn(
    ...
    typeof(HealthAdministrationServiceContractsModule),
...
public class HealthAdministrationServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthAdministrationServiceModule>();
        });
    }
        ...
        Configure<AbpDbContextOptions>(options =>
        {
            ...
            options.Configure<BlobStoringDbContext>(c =>
            {
                c.UseNpgsql(b =>
                {
                    ...
                    b.MigrationsAssembly(typeof(HealthAdministrationServiceModule).Assembly.GetName().Name);
                });
            });
        });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(HealthAdministrationServiceModule).Assembly, opts =>
                {
