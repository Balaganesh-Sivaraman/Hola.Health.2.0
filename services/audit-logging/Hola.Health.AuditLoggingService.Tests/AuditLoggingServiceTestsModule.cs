...
using Hola.Health.AuditLoggingService.Data;
using Volo.Abp;
...
namespace Hola.Health.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the Hola.Health.AuditLoggingService project,
 * but it does not have a module dependency to the HealthAuditLoggingServiceModule module class.
 * Because, HealthAuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthAuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthAuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthAuditLoggingServiceModule))]
