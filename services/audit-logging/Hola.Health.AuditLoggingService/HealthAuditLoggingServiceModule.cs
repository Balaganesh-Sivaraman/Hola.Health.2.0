...
[DependsOn(
    typeof(HealthAuditLoggingServiceContractsModule),
...
public class HealthAuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthAuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<HealthAuditLoggingServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(HealthAuditLoggingServiceModule).Assembly, opts =>
                {
