...
namespace Hola.Health.ChatService.Tests;

/* This project has a dotnet project reference to the Hola.Health.ChatService project,
 * but it does not have a module dependency to the HealthChatServiceModule module class.
 * Because, HealthChatServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthChatServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthChatServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthChatServiceModule))]
