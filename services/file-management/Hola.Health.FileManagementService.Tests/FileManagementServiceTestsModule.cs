...
namespace Hola.Health.FileManagementService.Tests;

/* This project has a dotnet project reference to the Hola.Health.FileManagementService project,
 * but it does not have a module dependency to the HealthFileManagementServiceModule module class.
 * Because, HealthFileManagementServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthFileManagementServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthFileManagementServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthFileManagementServiceModule))]
