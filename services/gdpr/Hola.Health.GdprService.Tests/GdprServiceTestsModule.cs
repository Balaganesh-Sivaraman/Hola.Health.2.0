...
using Hola.Health.GdprService.Data;
using Volo.Abp;
...
namespace Hola.Health.GdprService.Tests;

/* This project has a dotnet project reference to the Hola.Health.GdprService project,
 * but it does not have a module dependency to the HealthGdprServiceModule module class.
 * Because, HealthGdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthGdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthGdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthGdprServiceModule))]
