...
using Hola.Health.IdentityService.Data;
using Volo.Abp;
...
namespace Hola.Health.IdentityService.Tests;

/* This project has a dotnet project reference to the Hola.Health.IdentityService project,
 * but it does not have a module dependency to the HealthIdentityServiceModule module class.
 * Because, HealthIdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthIdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthIdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthIdentityServiceModule))]
