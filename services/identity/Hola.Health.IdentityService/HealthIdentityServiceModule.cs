...
namespace Hola.Health.IdentityService;
...
[DependsOn(
    ...
    typeof(HealthIdentityServiceContractsModule),
...
public class HealthIdentityServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthIdentityServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(HealthIdentityServiceModule).Assembly, opts =>
                {
