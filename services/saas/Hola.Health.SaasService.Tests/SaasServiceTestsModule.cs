...
using Hola.Health.SaasService.Data;
using Volo.Abp;
...
namespace Hola.Health.SaasService.Tests;

/* This project has a dotnet project reference to the Hola.Health.SaasService project,
 * but it does not have a module dependency to the HealthSaasServiceModule module class.
 * Because, HealthSaasServiceModule has configurations proper for development and production
 ...
 *
 * For example, HealthSaasServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change HealthSaasServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(HealthSaasServiceModule))]
