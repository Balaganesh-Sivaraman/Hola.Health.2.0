...
namespace Hola.Health.SaasService;
...
[DependsOn(
    ...
    typeof(HealthSaasServiceContractsModule),
...
public class HealthSaasServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<HealthSaasServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<HealthSaasServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(HealthSaasServiceModule).Assembly, opts =>
                {
